...
export function BimModelViewer({ modelUrl, label }: BimModelViewerProps) {
  ...
  return <>
    ...
    <div className="absolute left-4 top-4 z-10 flex items-center gap-2 rounded-xl border border-white/[.08] bg-[var(--airport-sidebar)]/82 p-1.5 shadow-xl backdrop-blur-xl">
