...
export const BMS_BUILDINGS: BmsBuilding[] = [
  { id: "terminal-t1", name: "R&D and Innovation Center" },
  { id: "utility-plant", name: "Central Utility Plant" },
  { id: "mini-dc", name: "High-Tech Park Mini Data Center" },
];
...
export const ASSET_LOCATION_INFO: Record<string, AssetLocationInfo> = {
  ahu:     { code: "DHTP-AHU-RD-L2-01", building: "R&D and Innovation Center", floor: "Level 2", area: "R&D Mechanical Zone" },
  fcu:     { code: "DHTP-FCU-RD-L2-18", building: "R&D and Innovation Center", floor: "Level 2", area: "Laboratory Support Zone B" },
  vav:     { code: "DHTP-VAV-RD-L3-05", building: "R&D and Innovation Center", floor: "Level 3", area: "Cleanroom Support Zone C" },
  ...
  "crah-unit": { code: "DHTP-CRAH-DC-03", building: "High-Tech Park Mini Data Center", floor: "Level 1", area: "Data Hall 1" },
};
